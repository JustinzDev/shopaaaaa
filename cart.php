        ...
        <div class="headercart">
            <table class="tablecart">
                ...
                <?php while($rowdata = mysqli_fetch_array($query)){?>
                    <tr>
                        <td style="width:450px;"><img src="<?php echo $vps;?><?php echo $rowdata['product_img'];?>"/><?php echo $rowdata['product_name'];?></td>
                        ...
                        <td style="width:150px;"><a href="<?php echo $vps;?>api/removecartitem?itemid=<?php echo $rowdata['item_id'];?>">ลบ</a></td>
                    </tr>
                <?php }?>
            </table>
        </div>

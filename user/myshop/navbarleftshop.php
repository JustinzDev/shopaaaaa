...
<body>
    ...
    <ul id="nav">
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side.png" />การจัดส่ง</a><img alt="" />
            <ul>
        ...
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side2.png" />คำสั่งซื้อ</a><img alt="" />
            <ul>
        ...
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side3.png" />สินค้า</a><img  alt="" />
            <ul>
        ...
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side4.png" />Marketing Centre</a><img  alt="" />
            <ul>
        ...
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side5.png" />การเงิน</a><img  alt="" />
            <ul>
        ...
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side6.png" />ข้อมูล</a><img  alt="" />
            <ul>
                <li><a href="#">Business Insights</a></li>
                <li><a href="#">Account Health</a></li>
            </ul>
        </li>
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side7.png" />การเติบโต</a><img  alt="" />
            <ul>
                <li><a href="#">Seller Missions</a></li>
                <li><a href="#">ร้านค้าแนะนำ</a></li>
            </ul>
        </li>
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side8.png" />การบริการลูกค้า</a><img  alt="" />
            <ul>
                <li><a href="#">ตัวช่วยตอบแชท</a></li>
                <li><a href="#">ตัวช่วยจัดการ FAQ</a></li>
            </ul>
        </li>
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side9.png" />ร้านค้า</a><img  alt="" />
            <ul>
        ...
        <li><a href="#" class="sub" tabindex="1"><img src="<?php echo $vps;?>/assets/img/side10.png" />การตั้งค่า</a><img  alt="" />
            <ul>

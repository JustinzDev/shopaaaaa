                ...
                <div class="navbar-right">
                    ...
                    <div class="down" style="background-color:white;">
                        <div class="left-info">
                            ...
                            <h6>ศักรินทร์ สิมมา
                                (+66) 616450118
                                City Home รัชดา-ปื่นเกล้า ห้อง 589/26 ตึก A1 ถนนจรัญสนิทวงศ์ แขวงบางอ้อ เขตบางพลัด 10700 เขตบางพลัด จังหวัดกรุงเทพมหานคร 10700
                            </h6>
                        </div>
                        ...
                        <?php while($rowdata = mysqli_fetch_array($query)){?>
                            <div class="card-boxorder">
                                ...
                                <div class="body-boxitem">
                                    <img style="width:100px;" src="<?php echo $vps;?><?php echo $rowdata['product_img'];?>">
                                    <div class="infomessage-item">
                                        <span><?php echo $rowdata['product_details'];?></span><br>
                                        <span>x<?php echo $rowdata['list_counto'];?></span>
                                        <div class="item-price">
                                            ราคาต่อชิ้น: ฿<?php echo number_format($rowdata['product_price'], 2);?><br>
                                            ราคารวม: ฿<?php echo number_format($rowdata['invoice_total'], 2);?>
                                        </div>
                                    </div>
                                </div>
                            </div>
